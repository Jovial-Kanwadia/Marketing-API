...
export function AdPerformanceTable({ data, isLoading }: AdPerformanceTableProps) {
    ...
    if (isLoading) {
        return <div className="text-center py-4">Loading ad data...</div>
    }

    if (!data || data.length === 0) {
        return <div className="text-center py-4">No ad data available. Please select an ad account.</div>
    }
